...
export async function llamarNPC({ npc, userMessage, contextoExtra }: ChatParams) {
  ...
  switch (npc) {
    ...
    case 'supervisor':
      ...
      // Si este testigo es el mentiroso (V1), añadir instrucción
      ...
      // Si hay vínculo V4 con este testigo, añadirlo
      if (
